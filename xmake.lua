...
--Version
set_configvar("BTK_VERSION_STRING","0.0.1")
set_configvar("BTK_VERSION_MAJOR",0)
set_configvar("BTK_VERSION_MINOR",0)
set_configvar("BTK_VERSION_PATCH",1)

-- Option
option("bultin_gradients")
    set_default(false)
    set_showmenu(true)
    set_category("misc")
    set_description("Enable builtin gradients")
    set_configvar("BTK_USE_BUILTIN_GRADIENTS",true)
